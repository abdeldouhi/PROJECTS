                ...
                <div id="signup">
                    ...
                    <form action="php/Inscription.php" method="post">
                        ...
                        <div class="field-wrap">
                            ...
                            <input name="pass2" type="password"required autocomplete="off"/>
                        </div>
            ...
            <div id="login">   
                ...
                <form action="php/connexion.php" method="post">
                    ...
                    <div class="field-wrap">
                        ...
                        <input name="email3" type="email"required autocomplete="off"/>
                    </div>
                    ...
                    <div class="field-wrap">
                        ...
                        <input name="pass3" type="password"required autocomplete="off"/>
                    </div>
